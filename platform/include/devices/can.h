...
/************************* CAN_EXMOD 中断使能寄存器位定义************************/

 #define CAN_EXMOD_B2E			      ((unsigned char)0x80)	   /*!< Basic change to extend */
...
typedef struct
{
   ...
   unsigned char CMR;	//0x01
   unsigned char SR;	//0x02
   unsigned char IR;	//0x03
   unsigned char IER;	//0x04
   unsigned char reserved0;	//0x05
   unsigned char BTR0;		//0x06
   unsigned char BTR1;		//0x07
   //unsigned char OCR;
   unsigned char reserved1[3];	//0x08 - 0x0a
   unsigned char ALC;           //0x0b
   unsigned char ECC ;          //0x0c
   unsigned char EMLR;          //0x0d
   unsigned char RXERR;         //0x0e
   unsigned char TXERR;         //0x0f
   unsigned char BUF[13];       //0x10
   unsigned char RMCR;          //0x1d
   unsigned char reserver2;     //0x1e
   unsigned char EXMOD;         //0x1f
} CAN_TypeDef;
